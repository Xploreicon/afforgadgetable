  ...
  const applyCopon = () => {
    ...
    if (copon.percent <= 0) {
      ...
      if (!coponData.hasOwnProperty(values.copon)) {
        errorToast('coupon code is not correct', 'try again');
      }
    } else {
      ...
      <div className='cart-page'>
        <div className='cart-page__right'>
          <div className='cart-page__right__summery-box'>
            <h3 className='cart-page__right__summery-box__title'>summary</h3>
            <p className='cart-page__right__summery-box__discription'>
              you can use <span className='cart-page__test-important'></span> coupon 
            </p>
            <h4 className='cart-page__right__summery-box__order-price'>
              Order Total : {(totalProductsPrice - discount).toFixed(2)} NGN
            </h4>
