  ...
  return (
    <Container>
        ...
        <div className='product-page__content'>
          ...
          <div className='product-page__content__prices'>
            {product.discountPercent > 0 && (
              <del className='product-page__content__non-discount-price'>NGN {product.price}</del>
            )}
            <h4 className='product-page__content__price'>NGN {discountPrice}</h4>
          </div>
      ...
      <div className='product-page__discription'>
        <h4 className='product-page__discription__title'>description</h4>
      ...
      <div className='product-page__sugested-product'>
        <h4 className='product-page__sugested-product__title'>related products</h4>
